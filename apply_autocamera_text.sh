...
echo "==> AutoCameraActivity mit dynamischem Hinweistext aktualisieren"
cat > "$PKG/AutoCameraActivity.kt" <<'KOT'
  ...
  private fun startCameraThenCapture() {
    ...
    cameraProviderFuture.addListener({
      ...
      captureToCache { path ->
        ...
        tvHint.text = "Seitenprofil – bitte seitlich drehen (Foto in 5s)"
